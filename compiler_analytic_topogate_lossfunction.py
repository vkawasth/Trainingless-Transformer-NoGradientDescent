...
### Loss Function on basin's featurelessness experiment
from loss_function_experiment import run_loss_experiment
run_loss_experiment(model, get_batch, eval_val, phi_clean, gluing_defect, LR)
