...
K_DIM = 4  # Expanded Krylov dimension k = 4
...
# =====================================================================
# 2. ADAPTIVE KRYLOV-NEWTON OPTIMIZER (k=4, lr_ortho floor=8e-4)
# =====================================================================
class AdaptiveKrylovSubspaceSignAdam:
    def __init__(
        ...
        lr_ortho_min=8e-4,        # Adjusted floor scale (8e-4)
...
def main():
    ...
    # Config: lr_kn = 0.50, lr_ortho = 2e-3 -> 8e-4 (Cosine Floor), k = 4
    ...
    print("=" * 125)
    print(f" INTEGRATED FISHER-GRASSMANN OPTIMIZER (P={P}, k={K_DIM}) | COSINE FLOOR = 8e-4")
    print(" Config: lr_kn = 0.50 | lr_ortho = 2e-3 -> 8e-4 (Cosine) | floor = 0.50 | beta1_ortho = 0.95")
    print("=" * 125)
