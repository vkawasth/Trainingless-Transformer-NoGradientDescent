...
# =====================================================================
# 2. ADAPTIVE KRYLOV-NEWTON OPTIMIZER WITH COSINE DECAYED COMPLEMENT
# =====================================================================
class AdaptiveKrylovSubspaceSignAdam:
    def __init__(
        ...
        lr_ortho_min=2e-4,        # Final decayed complement scale
    ...
    def get_current_lr_ortho(self, total_steps=120):
        """Cosine decay schedule for lr_ortho."""
...
def main():
    ...
    # Config: lr_kn = 0.50, lr_ortho = 2e-3 -> 2e-4 (Cosine), beta1_ortho = 0.95
    ...
    print("=" * 125)
    print(f" INTEGRATED FISHER-GRASSMANN OPTIMIZER (P={P}, k={K_DIM}) | COSINE DECAYED ORTHO-SCHEDULER")
    print(" Config: lr_kn = 0.50 | lr_ortho = 2e-3 -> 2e-4 (Cosine) | floor = 0.50 | beta1_ortho = 0.95")
    print("=" * 125)
