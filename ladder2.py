        ...
        with torch.no_grad():
            for n,p in snamed:
                for bi in range(NB):
                    ...
                    if crit in ("lowrank","resid","sign","signN","gsign","msign","randN","lrN","lrT","supT","supN","rowT","rowN","resT","resN","magT","magN","rowscale","colscale","spectrum"):
                        ...
                        elif crit in ("resT","resN","magT","magN"):
