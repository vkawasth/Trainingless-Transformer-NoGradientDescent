...
# At top of compiler_geometric.py, after imports:
from p3_wall_crossing import TauSpikeLogger
...
for step in range(1, 151):
    ...
    if step % 8 == 0:
        ...
        # Inside basin settle loop, after τ is computed (wherever you print τ):
        logger.check(step, tau, v, pc, model.state_dict())
