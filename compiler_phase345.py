...
#   (3) compression : u' = P_Q u + alpha_role (I - P_Q) u,  56 dims
...
_SUB_MAXCOAST = 2
_SUB_VERBOSE  = True
_SUB_GEOVAL   = 0.6   # geo-stop also requires val <= this
...
def _sub_report():
    ...
    print(f"  [345] dims {_sub_stats['dims']} (asked 56)/{_sub_P}  coast:{mode}  backward {b}  coasted {c}  "
