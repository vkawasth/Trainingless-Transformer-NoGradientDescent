...
# ---- SubTrack++ LowRankAdamW, authors' implementation ----
import sys as _sys, types as _types, torch as _t
_sys.path.insert(0, r"/Users/vaw1/Downloads/OGB/connectome/phaseTransition_phaseTransition_complex/FukayaAUComplex/longChainHllucinationp-adic/j-holomorphic-Fukaya/Subtrack")
...
_st_groups = [
    {"params": _st_mats, "module_names": _st_names,
     ...
     "proj_type": "std",
     "st_init_step_size": 10000.0,             # their --st_init_step_size
     "subspace_update_method": "subtrack",
     "subspace_update_interval": 25,
     ...
     "norm_growth_limit": 1.01,            # the zeta limiter of eq (12)
...
print(f"  [subtrack++] authors' LowRankAdamW: rank 8, scale 0.25, "
      f"eta 10000.0, interval 25, "
      f"adaptive=True, recovery=True")
