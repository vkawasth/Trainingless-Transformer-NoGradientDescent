...
print(f"  Teacher val={teacher_final_val:.4f}\n")
...
print(f"  Teacher val={teacher_final_val:.4f}  Student val={val_s:.4f}\n")
...
print("="*65)
print(f"\n  Teacher (24L):              val={teacher_final_val:.4f}")
...
print(f"""
  ...
  Gap from teacher: {best[1]-teacher_final_val:.4f} nats
