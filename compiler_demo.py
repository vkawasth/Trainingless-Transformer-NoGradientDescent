...
parser.add_argument('--mf_rounds',   type=int, default=3,
                    help='MF pump rounds (default 3, confirmed)')
...
v0=eval_val(model)
print(f"  Spectral E₀ + pre-bake: val={v0:.4f}  [{time.time()-t0:.1f}s]"); print()
...
print(f"  Confirmed (mean_field_init.py): 3 rounds → val=8.58")
